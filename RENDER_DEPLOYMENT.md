...
3. **The code automatically handles CORS** for Render domains
...
- Verify the build script runs correctly
...
#### 6. **Service Sleeping (Free Tier)**
**Solution:**
- Free tier services sleep after 15 minutes of inactivity
- Upgrade to Starter plan ($7/month) to prevent sleeping
- Use a service like UptimeRobot to ping your service
...
4. **Environment Variables:**
   - Backend: `GROQ_API_KEY`, `DEBUG=False`, `RENDER=true`
...
- ✅ **Database included** - No external setup needed
- ✅ **Simple deployment** - Everything in one platform
